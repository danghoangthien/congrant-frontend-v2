...
import { dataSource, pagination, COLUMN_SETTING_LOCALSTORAGE, columnMap } from '../lightMetaData';
...
const contractPlanList = {
  name: 'contractPlanLightList',
...
store.addModel(contractPlanList);
